...
// $.ajax({
//     url:"ajax/tableTestimonials.ajax.php",
...
$(".tableTestimonials").DataTable({
    "ajax": "ajax/tableTestimonials.ajax.php",
	"deferRender": true,
	"retrieve": true,
	"processing": true,
    "language": {
...
$(".tableTestimonials tbody").on("click", ".btnEditarTestimonio", function(){
...
$(".tableTestimonials tbody").on("click", ".btnEliminarTestimonio", function(){
