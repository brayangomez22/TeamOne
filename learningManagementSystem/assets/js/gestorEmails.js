$(document).ready(function(){
	...
	$(".tablaEmail tbody").on("click", ".btnverEmails", function(){
		...
		datos.append("idInstitucion", idInstitucion);
					...
					var post = `
						...
						<li>`;
							...
							if(extension == "jpg" || extension == "png"){
								post +=`<span class="mailbox-attachment-icon has-img"><img src="assets/archivos_emails/`+respuesta[0]["archivo"]+`" alt="Attachment"></span>`;
							}else{
								post +=`<span class="mailbox-attachment-icon"><i class="fa fa-file-pdf-o"></i></span>`;
							}

							post +=`<div class="mailbox-attachment-info">
								<a href="assets/archivos_emails/`+respuesta[0]["archivo"]+`" class="mailbox-attachment-name" download=`+respuesta[0]["archivo"]+`><i class="fa fa-paperclip"></i>`+respuesta[0]["archivo"]+`</a>
								<span class="mailbox-attachment-size">
									1,245 KB
									<a href="assets/archivos_emails/`+respuesta[0]["archivo"]+`" class="btn btn-default btn-xs pull-right" download=`+respuesta[0]["archivo"]+`><i class="fas fa-cloud-download-alt"></i></a>
								</span>
							</div>
						</li>
					`;
