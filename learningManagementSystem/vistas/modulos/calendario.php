          ...
          <div class="box box-solid">
            ...
            <div class="box-body">
              ...
              <div id="external-events">
                ...
                <div class="external-event bg-yellow">Vete a casa</div>
                <div class="external-event bg-aqua">Hacer los deberes</div>
                <div class="external-event bg-light-blue">Trabajar en diseño de interfaz de usuario</div>
                <div class="external-event bg-red">Dormir apretado</div>
                <div class="checkbox">
