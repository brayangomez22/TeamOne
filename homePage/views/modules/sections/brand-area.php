...
<section class="brand-area wow bounce delay-1s" style="margin-top: 30px;">
    <div class="title-heading">
        <h1 class="title-text">Clientes Satisfechos</h1>
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6 col-lg-12 col-md-12 wow zoomInLeft delay-1s">
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 wow zoomInRight delay-1s">
                <div class="experience-area">
                    ...
                    <div class="d-flex flex-row flex-wrap call-area">
                        ...
                        <div class="call-now">
                            ...
                            <span class="font-roboto py-2">(+57)-301-393-2979</span>
                        </div>
                    </div>
